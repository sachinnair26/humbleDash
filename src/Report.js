            ...
            if (v.average === 1) {
              ...
              for (var x = 0; x <= 24; x++) {
                if (time2 === x) {
                  ...
                  if (!average[date2.slice(0, 15)][x]) {
                    average[date2.slice(0, 15)][x] =
                      average[date2.slice(0, 15)][x] + 0 || 0;
                  } else {
                    average[date2.slice(0, 15)][x] =
                      average[date2.slice(0, 15)][x] + 0 || 0;
                  }
                      ...
                      d =>
                        this.state.good[c.toString()][d.toString()] >= 5 ? (
                          <td style={{ backgroundColor: "green" }}>
                            {this.state.good[c.toString()][d.toString()]}
                          </td>
                        ) : (
                      ...
                      d =>
                        this.state.bad[c.toString()][d.toString()] >= 5 ? (
                          <td style={{ backgroundColor: "red" }}>
                            {this.state.bad[c.toString()][d.toString()]}
                          </td>
                    ...
                    {this.state.hours.map(
                      d =>
                        this.state.average[c.toString()][d.toString()] >= 7 ? (
                          <td style={{ backgroundColor: "red" }}>
                            {this.state.average[c.toString()][d.toString()]}
                          </td>
                        ) : this.state.average[c.toString()][d.toString()] >=
                        4 ? (
                          <td style={{ backgroundColor: "yellow" }}>
