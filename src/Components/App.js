...
import {FetchReport,ResetReport} from './Actions/FetchReport'
...
this.props.FetchReport(
  ...
  onCancelColumnModal = () =>{
    this.setState({modalforreport:false})
    ...
    return (
      <div className='App'>
        ...
        >
          ...
          >
          <div className='red-button-for-report' onClick={() => {
           ...
           Generate Report
            ...
            <div >
              ...
              <DeviceTable getData={this.getTableData}  onClickSingleColumnOnTable={this.onClickSingleColumnOnTable}/>
            </div>
          </div>
        </div>
        <Modal
          ...
          onCancel={this.onCancelForReportModal}
        >
        ...
        <Modal
        title='7 day report'
        visible={this.state.modalforreport}
        onOk={this.onOkColumnModal}
        onCancel={this.onCancelColumnModal}
        >
     <WeeklyReport/>
        </Modal>
      </div>
